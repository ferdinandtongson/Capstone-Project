...
/**************************************************************************************************/
/*
 * ScheduleDetailAdapter displays a list of exercise details defined in a particular routine
 */
/**************************************************************************************************/
...
/**************************************************************************************************/
/*
 * ScheduleDetailAdapter - constructor
 */
/**************************************************************************************************/
    /*
     * ScheduleDetailAdapter - constructor
     */
    public ScheduleDetailAdapter(Context ctx, int itemLayoutId){
        //get context
        mContext = ctx;
...
/**************************************************************************************************/
    ...
    /*
     * void setOnClickListener(...) - set listener to listen for item click events
     */
 ...
 *      void addItemAt(ClientRoutineItem,int) - add item to adapter at specific position
...
/**************************************************************************************************/
     ...
     * void replaceItemAt(...) - replace item at given position
     */
    public void replaceItemAt(ClientRoutineItem item, int position){
        //clear marker id list
        mMarkerList.clear();
    ...
    /*
     * void swapData(ArrayList<ClientRoutineItem>) - remove all data from adapter and replace with new data
     */
...
/**************************************************************************************************/
/*
 * void bindCardView(ClientRoutineItem,int,int) - bind data to itemView. Set tag values and contextMenu
