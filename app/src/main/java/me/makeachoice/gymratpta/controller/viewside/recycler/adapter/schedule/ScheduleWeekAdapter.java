...
/**************************************************************************************************/
     ...
     * AppointmentAdapter - constructor
     */
    public ScheduleWeekAdapter(Context ctx, int itemLayoutId){
        //get context
        mContext = ctx;
...
/**************************************************************************************************/
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if(mData.size() > 0){
            ...
            holder.bindTextView(item, item.isActive);
            holder.bindProfileImage(item, position, item.isActive);
        }
    }
...
/**************************************************************************************************/
     ...
     * description values.
     */
    private void bindTextView(AppointmentCardItem item, boolean isActive){
     ...
     */
    private void bindProfileImage(AppointmentCardItem item, int position, boolean isActive){
