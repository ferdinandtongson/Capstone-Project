...
public class ExerciseNav extends MyBottomNav implements BottomNavigationView.OnNavigationItemSelectedListener{
...
/**************************************************************************************************/
    ...
    private final static int DEFAULT_MENU_ID = R.menu.bottom_nav_exercise_menu;
...
/**************************************************************************************************/
     ...
     * BottomNavigationView - constructor
     */
    public ExerciseNav(MyActivity activity){
        //get activity
        mActivity = activity;
