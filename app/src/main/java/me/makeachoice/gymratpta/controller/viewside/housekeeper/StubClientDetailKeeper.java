...
/**************************************************************************************************/
/*
 * ClientDetailKeeper is responsible for maintaining the Appointment screen. It is directly responsible
 * for handling toolbar and drawer events (see GymRatBaseKeeper), bottom navigation events (see
 * ClientDetailNav) and the creation of ClientInfo, ClientSchedule and ClientHistory maids.
 *
