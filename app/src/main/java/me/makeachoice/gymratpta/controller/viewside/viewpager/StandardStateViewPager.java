...
/**************************************************************************************************/
/*
 * StandardStateViewPager displays different list of exercises separated by category.
 */

/**************************************************************************************************/

public class StandardStateViewPager {
...
/**************************************************************************************************/
    ...
    public StandardStateViewPager(MyActivity activity, ArrayList<String> titles, String baseMaidKey){
        //get activity
        mActivity = activity;
...
/**************************************************************************************************/
    ...
    private void initializeAdapter(int size){
        ...
        mAdapter = new ViewPagerStateAdapter(fm, mBaseMaidKey);
