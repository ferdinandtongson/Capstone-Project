...
/**************************************************************************************************/
/*
 * SessionDetailNav - helps manage bottom navigation bars used by activities
 */
/**************************************************************************************************/

public class SessionDetailNav extends MyBottomNav implements BottomNavigationView.OnNavigationItemSelectedListener{
...
/**************************************************************************************************/
/*
 * SessionDetailNav - constructor
 */
/**************************************************************************************************/
    /*
     * SessionDetailNav - constructor
     */
    public SessionDetailNav(MyActivity activity) {
        //get activity
        mActivity = activity;
    ...
    public SessionDetailNav(MyActivity activity, int bottomId, int menuId) {
        //get activity
        mActivity = activity;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (itemId) {
            ...
            case bottom_nav_item2: // 1 - list of exercise routines
                maid = maidRegistry.requestMaid(MaidRegistry.MAID_SESSION_STATS);
                break;
            case bottom_nav_item3: // 1 - list of exercise routines
                maid = maidRegistry.requestMaid(MaidRegistry.MAID_SESSION_NOTES);
                break;
            default:
                maid = null;
        }
