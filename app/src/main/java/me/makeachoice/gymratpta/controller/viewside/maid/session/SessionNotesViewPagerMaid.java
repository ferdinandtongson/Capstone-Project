...
public class SessionNotesViewPagerMaid extends MyMaid implements BasicFragment.Bridge {
...
/**************************************************************************************************/
/*
 * SessionNotesViewPagerMaid - constructor
 */
/**************************************************************************************************/
    /*
     * SessionNotesViewPagerMaid(...) - constructor
     */
    public SessionNotesViewPagerMaid(String maidKey, int layoutId){
        //get maidKey
        mMaidKey = maidKey;
