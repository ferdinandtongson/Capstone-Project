...
public class ExerciseStubData {
    ...
    private static void initArmExercises(Context ctx){
        ...
        item01.recordSecondary = ctx.getString(R.string.exerciseData_reps);
        item01.recordPrimary = ctx.getString(R.string.exerciseData_weight);
        mArms.add(item01);
        ...
        item02.recordSecondary = ctx.getString(R.string.exerciseData_reps);
        item02.recordPrimary = ctx.getString(R.string.exerciseData_weight);
        mArms.add(item02);
        ...
        item03.recordSecondary = ctx.getString(R.string.exerciseData_reps);
        item03.recordPrimary = ctx.getString(R.string.exerciseData_weight);
        mArms.add(item03);
        ...
        item04.recordSecondary = ctx.getString(R.string.exerciseData_reps);
        item04.recordPrimary = ctx.getString(R.string.exerciseData_weight);
        mArms.add(item04);
        ...
        item05.recordSecondary = ctx.getString(R.string.exerciseData_reps);
        item05.recordPrimary = ctx.getString(R.string.exerciseData_weight);
        mArms.add(item05);
        ...
        item06.recordSecondary = ctx.getString(R.string.exerciseData_reps);
        item06.recordPrimary = ctx.getString(R.string.exerciseData_weight);
        mArms.add(item06);
        ...
        item07.recordSecondary = ctx.getString(R.string.exerciseData_reps);
        item07.recordPrimary = ctx.getString(R.string.exerciseData_weight);
        mArms.add(item07);
    ...
    private static void initCardioExercises(Context ctx){
        ...
        item01.recordSecondary = ctx.getString(R.string.exerciseData_time);
        item01.recordPrimary = ctx.getString(R.string.exerciseData_distance);
        mCardio.add(item01);

        ExerciseFBItem item02 = new ExerciseFBItem();
        item02.exerciseName = "Stationary Bike";
        item02.exerciseCategory = ctx.getString(R.string.exerciseCategory_cardio);
        item02.recordSecondary = ctx.getString(R.string.exerciseData_time);
        item02.recordPrimary = ctx.getString(R.string.exerciseData_distance);
        mCardio.add(item02);

        ExerciseFBItem item03 = new ExerciseFBItem();
        item03.exerciseName = "Elliptical Trainer";
        item03.exerciseCategory = ctx.getString(R.string.exerciseCategory_cardio);
        item03.recordSecondary = ctx.getString(R.string.exerciseData_time);
        item03.recordPrimary = ctx.getString(R.string.exerciseData_distance);
        mCardio.add(item03);

        ExerciseFBItem item04 = new ExerciseFBItem();
        item04.exerciseName = "Stair-Climber";
        item04.exerciseCategory = ctx.getString(R.string.exerciseCategory_cardio);
        item04.recordSecondary = ctx.getString(R.string.exerciseData_time);
        item04.recordPrimary = ctx.getString(R.string.exerciseData_distance);
        mCardio.add(item04);

        ExerciseFBItem item05 = new ExerciseFBItem();
        item05.exerciseName = "Rowing Machine";
        item05.exerciseCategory = ctx.getString(R.string.exerciseCategory_cardio);
        item05.recordSecondary = ctx.getString(R.string.exerciseData_time);
        item05.recordPrimary = ctx.getString(R.string.exerciseData_distance);
        mCardio.add(item05);

        ExerciseFBItem item06 = new ExerciseFBItem();
        item06.exerciseName = "Jump Rope";
        item06.exerciseCategory = ctx.getString(R.string.exerciseCategory_cardio);
        item06.recordSecondary = ctx.getString(R.string.seconds);
        item06.recordPrimary = ctx.getString(R.string.minutes);
        mCardio.add(item06);

        ExerciseFBItem item07 = new ExerciseFBItem();
        item07.exerciseName = "Jumping Jacks";
        item07.exerciseCategory = ctx.getString(R.string.exerciseCategory_cardio);
        item07.recordSecondary = ctx.getString(R.string.seconds);
        item07.recordPrimary = ctx.getString(R.string.minutes);
        mCardio.add(item07);
