...
public class ExerciseStubData {
    ...
    private static ArrayList<ExerciseItem> mArms;
    private static ArrayList<ExerciseItem> mBack;
    private static ArrayList<ExerciseItem> mCardio;
    private static ArrayList<ExerciseItem> mChest;
    private static ArrayList<ExerciseItem> mCore;
    private static ArrayList<ExerciseItem> mLegs;
    private static ArrayList<ExerciseItem> mShoulders;
    ...
    public static ArrayList<ExerciseItem> getExercises(int category){
        switch(category){
            case ARMS:
                return mArms;
            case BACK:
    ...
    private static void initArmExercises(Context ctx){
        ...
        ExerciseItem item01 = new ExerciseItem();
        ...
        ExerciseItem item02 = new ExerciseItem();
        ...
        ExerciseItem item03 = new ExerciseItem();
        ...
        ExerciseItem item04 = new ExerciseItem();
        ...
        ExerciseItem item05 = new ExerciseItem();
        ...
        ExerciseItem item06 = new ExerciseItem();
        ...
        ExerciseItem item07 = new ExerciseItem();
