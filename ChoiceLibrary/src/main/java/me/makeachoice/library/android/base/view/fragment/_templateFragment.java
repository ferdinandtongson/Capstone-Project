...
public class _templateFragment extends MyFragment {
     ...
     * get an exception
     */
    public static _templateFragment newInstance(int id){
        _templateFragment f = new _templateFragment();
