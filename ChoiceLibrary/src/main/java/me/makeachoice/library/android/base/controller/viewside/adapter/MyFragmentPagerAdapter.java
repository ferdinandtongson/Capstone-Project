...
/**************************************************************************************************/
/*
 * MyFragmentPagerAdapter extends FragmentPagerAdapter to handle the switching between different
 * fragments. Used when there are a small set of Fragments to manage (like a set of tabs). The
 * adapter needs getCount() and getItem() to properly function. The count is needed so the adapter
 * knows how many pages to account for and getItem() is for the adapter to properly display the
 * requested fragment
 *
 ...
 */
/**************************************************************************************************/
    public MyFragmentPagerAdapter(FragmentManager fm, Bridge bridge){
        super(fm);
